...
export const Cart = (props) => {
  //unpack the props that were received
  ...
  const onInputChangeHandler = (name, input) => {
    ...
    props.dispatch(changeItemQuantity(name, newQuantity));
  };

  // Use the cart and currencyFilter slices to render their data.
  //extract an array of the keys from the cart object and pass each of them (map them) to the createCartItem function
